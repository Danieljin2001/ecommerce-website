          ...
          <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
            <div className='flex flex-col text-gray-600'>
              <div onClick={()=>setVisible(false)} className='flex items-center gap-2 p-3 cursor-pointer'>
                <img className='h-4' src={assets.left_arrow_icon}/>
                <p>Back</p>
              </div>
              <NavLink onClick={()=>setVisible(false)} className="py-2 pl-6 border-y-1" to='/'>HOME</NavLink>
              ...
              <NavLink onClick={()=>setVisible(false)} className="py-2 pl-6 border-b-1" to='/contact'>CONTENT</NavLink>
